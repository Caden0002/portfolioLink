...
const design1 = "Figma";
const design1Link =
  "https://www.figma.com/file/LtM3Uo7Bd15BFHyZIceQXT/Caden-Linktree?type=design&node-id=1%3A29&mode=design&t=HYxCfWs1Teon1L6g-1";
      ...
      <div id="Footer" className="flex flex-col items-center p-8">
        ...
        <div className="flex items-center space-x-2">
          <a
            ...
            className="font-mono text-xs text-neutral-50 hover:text-neutral-400 text-center z-10"
          >
            {design1}
          </a>
